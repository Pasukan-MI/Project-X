...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
        ...
        public_vars.$sidebarMenu.on('mouseover', function(ev)
		{
            show_sidebar_menu(false);
            public_vars.$sidebarMenu.find(".sidebar-collapse-icon").hide();
		});
        
        public_vars.$sidebarMenu.on('mouseleave', function(ev)
		{
            hide_sidebar_menu(false);
            public_vars.$sidebarMenu.find(".sidebar-collapse-icon").show();
		});
